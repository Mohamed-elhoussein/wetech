                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="m-5" action="" method="POST">
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="coupon" value="{{ $coupon->coupon }}"
                                                        placeholder="أدخل اسم فئة الخدمة" class="form-control"
                                                        id="horizontal-coupon-input">
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="discount" value="{{ $coupon->discount }}"
                                                        placeholder="قيمة الخصم" class="form-control"
                                                        id="horizontal-discount-input">
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="date" name="expired_at"
                                                        value="{{ trim(date('Y-m-d', strtotime($coupon->expired_at))) }}"
                                                        placeholder="" class="form-control"
                                                        id="horizontal-expired_at-input">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row d-flex justify-content-end mb-4">
                                                <button type="submit"
                                                    class=" col-sm-6 col-md-2 btn btn-warning w-md fs-4 p-1">تحديث
                                                    الخصم</button>
                                            </div>
                                    </div>
                                </div>
