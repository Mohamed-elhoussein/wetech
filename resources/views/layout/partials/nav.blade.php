    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box" style="padding: 0;">
                <a href="{{ route('dashbord') }}" class="logo logo-dark">
                    <span class="logo-sm">
                ...
                <a href="{{ route('dashbord') }}" class="logo logo-light">
                    <span class="logo-sm ">
                    </span>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-none d-lg-inline-block ms-1">
                ...
                <a href="{{ route('settings') }}" class="btn header-item noti-icon waves-effect"
                    style="display: inline">
                    <i class="bx bx-cog"></i>
                </a>
                <a target="_blank" href="{{ env('BASE_URL') }}" class="btn header-item noti-icon waves-effect"
                    style="display: inline">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="/user/profile"><i
                            class="bx bx-user font-size-16 align-middle me-1"></i> <span key="t-profile">الملف
                            الشخصي</span></a>
