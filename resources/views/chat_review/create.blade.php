    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18"> مراقب جديد</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-4">إضافة مراقب جديد</h4>
                        ...
                        <form class="m-5" action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-4">
                                <label for="horizontal-firstname-input" class="col-sm-3 col-form-label  fs-4">إسم
                                    المراقب</label>
                                <div class="col-sm-9">
                                    <input type="text" name="username" placeholder="أضف إسم المراقب" class="form-control" id="horizontal-firstname-input" value="{{ old('username') }}">
                                </div>
                            </div>
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <select name="country_id" class="form-select" id="country" onchange="getCountryDetails()">
                                        ...
                                        <option value="{{ $country->id }}" @if ($country->id == 191) selected @endif>
                                            {{ $country->name }}
                                        </option>
                                        @endforeach
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="number_phone" placeholder="أضف هاتف " class="form-control" id="horizontal-phone-input" value="{{ old('number_phone') }}">
                                </div>
                                <div class="col-sm-1">
                            ...
                            <div class="row mb-4">
                                <label for="horizontal-firstname-input" class="col-sm-3 col-form-label  fs-4">الإسم
                                    الأول</label>
                                <div class="col-sm-9">
                                    <input type="text" name="first_name" placeholder="أضف الإسم الأول" class="form-control" id="horizontal-firstname-input" value="{{ old('first_name') }}">
                                </div>
                            </div>
                            <div class="row mb-4">
                                <label for="horizontal-SecondName-input" class="col-sm-3 col-form-label  fs-4">الإسم
                                    الثاني</label>
                                <div class="col-sm-9">
                                    <input type="text" name="second_name" placeholder="أضف الإسم الثاني " class="form-control" id="horizontal-SecondName-input" value="{{ old('second_name') }}">
                                </div>
                            </div>
                            <div class="row mb-4">
                                <label for="horizontal-lastname-input" class="col-sm-3 col-form-label  fs-4">الإسم
                                    الأخير</label>
                                <div class="col-sm-9">
                                    <input type="text" name="last_name" placeholder="أضف الإسم الأخير" class="form-control" id="horizontal-lastname-input" value="{{ old('last_name') }}">
                                </div>
                            </div>
                            <div class="row mb-4">
                                <label for="horizontal-email-input" class="col-sm-3 col-form-label fs-4">البريد
                                    الإلكتروني</label>
                                <div class="col-sm-9">
                                    <input type="email" name="email" placeholder="أضف البريد الإلكتروني" class="form-control" id="horizontal-email-input" value="{{ old('email') }}">
                                </div>
                            </div>
                            <div class="row mb-4 border font-size-16 p-4  bg-gray rounded shadow ">
                                ...
                                <div class="form-check col-sm-3 mb-3">
                                    <input class="form-check-input" type="checkbox" id="{{ $country->code . '_id' }}" name="permission[{{ $country->id }}]" checked>
                            ...
                            <div class="row mb-4 border font-size-16 p-4  bg-gray rounded shadow ">
                                ...
                                <div class="form-check col-sm-3 mb-3">
                                    <input class="form-check-input" type="checkbox" id="{{ $permission }}" name="chat_review[{{ $permission }}]">
                            ...
                            <div class="row d-flex justify-content-end">
                                <button type="submit" class=" col-sm-6 col-md-2 btn btn-primary py-1 fs-5">إضافة</button>
                            </div>
                    </div>
                </div>
                </form>
