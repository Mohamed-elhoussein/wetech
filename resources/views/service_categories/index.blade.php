...
@section('title', 'قائمة تصنيف الخدمة')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18 ">قائمة تصنيف الخدمة</h4>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <a href="/service/category/create" class="btn btn-success w-md fs-5">أضف تصنيف
                                خدمة</a>

                            @include('partials.services.filter', [
                                'route' => route('service_categories.index'),
                            ])
                        </div>
                        ...
                        <div class="card-body">
                            <div class="col-lg-3 mb-4 d-flex align-items-end">
                                <div class="me-2" style="position: relative">
                                    ...
                                    <div class="dropdown-menu">
                                        <button data-bulk-url="{{ route('service_categories.bulk-action') }}"
                                                ...
                                                <td>
                                                    <div>
                                                        <a href="javascript: void(0);"
                                                            class="badge badge-soft-primary font-size-11 m-1">{{ date('d-y-M', strtotime($category->created_at)) }}</a>
                                                ...
                                                <td>
                                                    <ul class="list-inline font-size-20 contact-links mb-0">
                                                        <li class="list-inline-item px-2">
                                                            <a class="delete"
                                                                href="/service/category/delete/{{ $category->id }}"
                                                                title="Delete"><i class="bx bx-trash-alt "></i></a>
                                                        </li>
                                                        <li class="list-inline-item px-2">
                                                            <a href="/service/category/edit/{{ $category->id }}"
                                                                title="Edit"><i class="bx bx-pencil"></i></a>
                                                        </li>
                                                        <li class="list-inline-item px-2">
                                                            @if ($category->active)
                                                                <a href="/service/category/block/{{ $category->id }}"
                                                                    title="disable"><i class="bx bx-block"></i></a>
                                                            @else
                                                                <a href="/service/category/block/{{ $category->id }}"
