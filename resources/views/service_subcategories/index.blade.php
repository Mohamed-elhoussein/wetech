                ...
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <a href="/service/subcategories/create" class="btn btn-success w-md fs-5">أضف تصنيف
                                فرعي</a>

                            @include('partials.services.filter', [
                                'route' => route('service.subcategories.index'),
                            ])
                        </div>
                        ...
                        <div class="card-body">
                            <div class="col-lg-3 d-flex align-items-end mb-4">
                                <div class="me-2" style="position: relative">
                                    ...
                                    <div class="dropdown-menu">
                                        <button data-bulk-url="{{ route('service.subcategories.bulk-action') }}"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="font-size-14 mb-1"><a href="javascript: void(0);"
                                                            class="text-dark">{{ $serviceSubcategory->name }}</a>
                                                    </h5>
                                                </td>
                                                <td>{{ $serviceSubcategory->service_categories->name ?? '' }}
                                                </td>
                                                <td>{{ $serviceSubcategory->service_categories->services->name ?? '' }}
                                                </td>
                                                <td style="font-weight: bold">
                                                    @if ($serviceSubcategory->active)
                                                        <span
                                                ...
                                                <td>
                                                    <div>
                                                        <a href="javascript: void(0);"
                                                            class="badge badge-soft-primary font-size-11 m-1">{{ date('d-y-M', strtotime($serviceSubcategory->created_at)) }}</a>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <ul class="list-inline font-size-20 contact-links mb-0">
                                                        <li class="list-inline-item px-2">
                                                            <a class="delete"
                                                                href="/service/subcategories/delete/{{ $serviceSubcategory->id }}"
                                                                title="Delete"><i class="bx bx-trash-alt "></i></a>
                                                        </li>
                                                        <li class="list-inline-item px-2">
                                                            <a href="/service/subcategories/edit/{{ $serviceSubcategory->id }}"
                                                                title="Edit"><i class="bx bx-pencil"></i></a>
                                                        </li>
                                                        @if ($serviceSubcategory->active)
                                                            <li class="list-inline-item px-2">
                                                                <a href="/service/subcategories/block/{{ $serviceSubcategory->id }}"
