                            ...
                            <form class="m-5" action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-4">
                                    <label for="horizontal-title-input" class="col-sm-3 col-form-label fs-4">
                                        العنوان</label>
                                    <div class="col-sm-9">
                                        <input type="text" value="{{ $serviceSub4->name }} " name="name"
                                        ...
                                        <select class="form-select" id="service">
                                            @foreach ($services as $sercive)
                                                <option value="{{ $sercive->id }}"
                                                    @if ($sercive->id == $ids['service_id']) selected @endif>{{ $sercive->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-sm-9">
                                        <select name="service_id" class="form-select" id="service_category">
                                            @foreach ($service_category as $sercive)
                                                <option value="{{ $sercive->id }}"
                                                    @if ($sercive->id == $ids['service_categories_id']) selected @endif>{{ $sercive->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-9">
                                        <select name="service_subcategories_id" class="form-select"
                                            ...
                                            @foreach ($service_subcategory as $sercive)
                                                <option value="{{ $sercive->id }}"
                                                    @if ($sercive->id == $ids['service_subcategories_id']) selected @endif>{{ $sercive->name }}
                                                </option>
                                            @endforeach
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-select" id="service_sub2">
                                            @foreach ($service_sub2 as $sercive)
                                                <option value="{{ $sercive->id }}"
                                                    @if ($sercive->id == $ids['service_sub2_id']) selected @endif>{{ $sercive->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="row mb-4">
                                    <label for="horizontal-title-input" class="col-sm-3 col-form-label fs-4">
                                        التصنيف الفرعي الثالث للخدمة </label>
                                    <div class="col-sm-9">
                                        <select name="service_sub3_id" class="form-select" id="service_sub3">
                                            @foreach ($service_sub3 as $sercive)
                                                <option value="{{ $sercive->id }}"
                                                    @if ($sercive->id == $ids['service_sub3_id']) selected @endif>
                                                    {{ $sercive->name }}
                                                </option>
                                            @endforeach
                                        </select>
