        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">انواع المنتجات</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title mb-4">إضافة نوع جديد</h4>
                            ...
                            <form class="m-md-5" action="{{ route('product-types.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row mb-4">
                                ...
                                <div class="row mb-4">
                                    <label for="horizontal-category-input" class="col-sm-3 col-form-label fs-4">
                                        تصنيف النوع
                                    </label>
                                    <div class="col-sm-9">
                                        <select name="product_categories_id" class="form-select" id="horizontal-category-input">
