...
@section('title', 'قائمة مراقبي الرسائل')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18"> قائمة مراقبي الرسائل</h4>

                        <div class="d-flex align-items-center">
                            <a href="{{ route('chat_review.create') }}" class="btn btn-success w-md">اضافة مراقب للرسائل
                            </a>
                            <span onclick="exportTasks(event.target);" data-href="{{ route('user.chat_reviews.export') }}"
                                id="export" class="ms-2 btn btn-primary">
                                إستخراج
                            </span>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-end col-lg-3 mb-4 ">
                                <div class="me-2" style="position: relative">
                                    ...
                                    <div class="dropdown-menu">
                                        <button data-bulk-url="{{ route('user.chat-review.bulk-action') }}"
                                ...
                                <form class="table_users w-100" action="">
                                    <div class="position-relative">
                                        <input @if (request()->get('key_search')) autofocus @endif id="" name="key_search"
                                            ...
                                            placeholder=" خانة البحث  كمثال (الهاتف)" class="mt-2 _search form-control px-4"
                                            type="text">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <p class="text-muted mb-0">
                                                        {{ Str::lower(str_replace('_', ' ', $user->role)) }}
                                                    </p>
                                                </td>
                                                <td>
                                                    <h5 class="font-size-14 mb-1"><a href="javascript: void(0);"
                                                            class="text-dark">{{ $user->first_name }}</a>
                                                    </h5>
                                                </td>
                                                <td>
                                                    <h5 class="font-size-14 mb-1"><a href="javascript: void(0);"
                                                            class="text-dark">{{ $user->second_name }}</a>
                                                    </h5>
                                                </td>
                                                <td>
                                                    <h5 class="font-size-14 mb-1"><a href="javascript: void(0);"
                                                            class="text-dark">{{ $user->last_name }}</a>
                                                    </h5>
                                                </td>
                                                ...
                                                <td>
                                                    <ul class="list-inline font-size-20 contact-links mb-0">
                                                        <li class="list-inline-item px-2">
                                                            <a class="delete"
                                                                href="/user/chat/review/delete/{{ $user->id }}"
                                                                title="Delete"><i class="bx bx-trash-alt "></i></a>
                                                        </li>
                                                        <li class="list-inline-item px-2">
                                                            <a href="{{ route('chat_review.edit', $user->id) }}"
