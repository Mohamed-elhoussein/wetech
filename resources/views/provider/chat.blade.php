                        ...
                        <div class="card-body">
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                            <h4 class="mb-sm-0 font-size-18">الرسائل</h4>
                                            ...
                                            <div class="py-4 border-bottom">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <h5 class="font-size-15 mb-1">{{ 'admin' }}</h5>
                                                        ...
                                                        <div>
                                                            ...
                                                            <ul class="list-unstyled chat-list" data-simplebar="init"
                                                                                        ...
                                                                                        <a href="javascript: void(0);">
                                                                                            <div class="d-flex">
                                                                                                <div
                                                                                                    ...
                                                                                                    <i
                                                                                                        class="mdi mdi-circle font-size-10"></i>
                                                                                                </div>
                                                                                                <div
                                                                                                    class="flex-shrink-0 align-self-center me-3">
                                                                                        ...
                                                                                        <a href="javascript: void(0);">
                                                                                            <div class="d-flex">
                                                                                                <div
                                                                                                    class="flex-shrink-0 align-self-center me-3">
                                                                                                    <i
                                                                                                        class="mdi mdi-circle text-warning font-size-10"></i>
                                                                                                </div>
                                                                                                <div
                                                                                                    class="flex-shrink-0 align-self-center me-3">
                                                                ...
                                                                <div class="simplebar-track simplebar-vertical"
                                                                    style="visibility: hidden;">
                                                                    <div class="simplebar-scrollbar"
                                                                        style="height: 346px; transform: translate3d(0px, 0px, 0px); display: none;">
                                                                    </div>
                                                                </div>
                                                            </ul>
                                                        </div>
                                                    ...
                                                    <div class="tab-pane active" id="contacts">
                                                        ...
                                                        <div data-simplebar="init" style="max-height: 410px;">
                                                            <div class="simplebar-wrapper" style="margin: 0px;">
                                                                ...
                                                                <div class="simplebar-placeholder"
                                                                    style="width: auto; height: 585px;"></div>
                                                            </div>
                                                            <div class="simplebar-track simplebar-horizontal"
                                                                style="visibility: hidden;">
                                                                <div class="simplebar-scrollbar"
                                                            ...
                                                            <div class="simplebar-track simplebar-vertical"
                                                                ...
                                                                <div class="simplebar-scrollbar"
                                                                    style="transform: translate3d(0px, 0px, 0px); display: block; height: 287px;">
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="chat-conversation p-3">
                                                    <ul class="list-unstyled mb-0" data-simplebar="init"
                                                        ...
                                                        <div class="simplebar-track simplebar-vertical"
                                                            style="visibility: visible;">
                                                            <div class="simplebar-scrollbar"
                                                                style="height: 353px; transform: translate3d(0px, 0px, 0px); display: block;">
                                                            </div>
                                                        </div>
                                                    </ul>
                                                </div>
