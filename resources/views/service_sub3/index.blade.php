...
@section('title', 'قائمة التصنيف الفرعي للخدمات الثالت')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18 "> قائمة التصنيف الفرعي للخدمات الثالت</h4>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <a href="/service/sub3/create" class="btn btn-success w-md fs-5">أضف تصنيف
                                فرعي ثالت</a>

                            @include('partials.services.filter', [
                                'route' => route('service.sub3.index'),
                            ])
                        </div>
                        ...
                        <div class="card-body">
                            <div class="col-lg-3 mb-4 d-flex align-items-end">
                                <div class="me-2" style="position: relative">
                                    ...
                                    <div class="dropdown-menu">
                                        <button data-bulk-url="{{ route('service.sub3.bulk-action') }}"
                            ...
                            <div class="table-responsive">
                                <table class="table align-middle table-nowrap table-hover">
                                    ...
                                    <tbody>
                                        @foreach ($serviceSub3s as $serviceSub3)
                                            <tr>
                                                <td>
                                                    <input type="checkbox" class="bulk__check form-check"
                                                        value="{{ $serviceSub3->id }}">
                                                </td>
                                                <td>
                                                    <h5 class="font-size-14 mb-1"><a href="javascript: void(0);"
                                                            class="text-dark">{{ $serviceSub3->name }}</a>
                                                    </h5>
                                                </td>

                                                <td>{{ $serviceSub3->service_sub_2->name ?? '' }}</td>
                                                <td>{{ $serviceSub3->service_sub_2->service_subcategories->name ?? '' }}
                                                </td>

                                                <td style="font-weight: bold">
                                                    @if ($serviceSub3->active)
                                                        <span
                                                ...
                                                <td>
                                                    <div>
                                                        <a href="javascript: void(0);"
                                                            class="badge badge-soft-primary font-size-11 m-1">{{ date('d-y-M', strtotime($serviceSub3->created_at)) }}</a>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <ul class="list-inline font-size-20 contact-links mb-0">
                                                        <li class="list-inline-item px-2">
                                                            <a class="delete"
                                                                href="/service/sub3/delete/{{ $serviceSub3->id }}"
                                                                title="Delete"><i class="bx bx-trash-alt "></i></a>
                                                        </li>
                                                        <li class="list-inline-item px-2">
                                                            <a href="/service/sub3/edit/{{ $serviceSub3->id }}"
                                                                title="Edit"><i class="bx bx-pencil"></i></a>
                                                        </li>
                                                        @if ($serviceSub3->active)
                                                            <li class="list-inline-item px-2">
                                                                <a href="/service/sub3/block/{{ $serviceSub3->id }}"
