...
@section('title', 'تعديل التصنيف الفرعي للخدمات الثالت')
                            ...
                            <form class="m-5" action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-4">
                                    <label for="horizontal-title-input" class="col-sm-3 col-form-label fs-4">
                                        العنوان</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="name" value="{{ $serviceSub3->name }}"
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="" class="form-select" id="service_subcategory">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="service_sub2_id" class="form-select" id="service_sub2">
                                            @foreach ($service_sub2 as $sercive)
                                                <option value="{{ $sercive->id }}"
                                                    @if ($sercive->id == $ids['service_sub2_id']) selected @endif>
                                                    {{ $sercive->name }}
                                                </option>
                                            @endforeach
                                ...
                                <div class="row d-flex justify-content-end mb-4">
                                    <button type="submit" class=" col-sm-6 col-md-2 btn btn-warning w-md fs-4 p-1">ثحديت
                                        التصنيف
                                        الفرعي</button>
                                </div>
                        </div>
