...
<body>
    ...
    <div class="row  mh-100 w-100 ">
        <div class="col-12 col-md-6 col-lg-4 mt-10 mx-auto">
            <div class="card">
                <div class="card-body">
                    <div style="height:160px;" class="d-flex justify-content-center mb-3">
                        <img src="/images/paypal/logo.png" class="h-100 m-auto" alt="paypal">
                    </div>

                    <h3 class="text-center my-3 "> <span>لقد تم الدفع بنجاح</span></h3>

                    <h5 class="mt-5" dir="rtl"><strong>طريقة الدفع : </strong></h5>

                    <div class="m-auto text-center my-2 p-2 ">
                        <svg xmlns="http://www.w3.org/2000/svg" height="50px" viewBox="0 0 201.143 96.952">
                            <defs>
                                <style>
                                    .a,
                                    .b {
                            ...
                            <g transform="translate(-892.327 -960.8)">
                                <g transform="translate(892.327 960.8)">
                                    <path class="a" d="M636.3,645.342l27.908-.212.038,5.083-27.908.212"
                                        transform="translate(-635.853 -585.615)" />
                                    <path class="a" d="M636.288,643.3l27.908-.212.038,5.083-27.908.212"
                                        transform="translate(-635.902 -592.046)" />
                                    <path class="a" d="M636.272,641.261l27.908-.212.039,5.083-27.908.212"
                                        transform="translate(-635.951 -598.483)" />
                                    <path class="a" d="M636.257,639.3l41.951-.318.039,5.083-41.951.318"
                                        transform="translate(-636 -604.994)" />
                                    <path class="a" d="M636.241,637.264l41.951-.318.038,5.083-41.951.318"
                                        transform="translate(-636.048 -611.424)" />
                                    <path class="a" d="M636.225,635.3l55.914-.424.038,5.083-55.914.424"
                                        transform="translate(-636.097 -617.936)" />
                                    <path class="a" d="M636.21,633.265l55.914-.424.038,5.083-55.914.424"
                                        transform="translate(-636.146 -624.369)" />
                                    <path class="a" d="M636.195,631.225l55.914-.424.039,5.083-55.914.424"
                    ...
                    <div class=" mt-5 border border-2 border-success rounded p-2 badge-soft-success     text-center">
                        <span> your payment was success</span>
                    </div>
                </div>
            </div>
        </div>
