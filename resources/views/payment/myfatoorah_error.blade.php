...
<body>
    ...
    <div class="row  mh-100 w-100 ">
        <div class="col-11 col-md-6 col-lg-4 mt-10 mx-auto">
            <div class="card">
                <div class="card-body">
                    ...
                    <h3 class="text-center my-3 "> <span>الدفع لم يمر بالشكل المطلوب المرجو التحقق من حسابك وقم بمراسلتنا
                        </span></h3>
                    ...
                    <div class=" mt-5 border border-2 border-danger rounded p-2 badge-soft-danger     text-center">
                        <span> Payment failed, please check</span>
                    </div>
