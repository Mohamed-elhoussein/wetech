                    ...
                    <div class="nk-block nk-block-middle nk-auth-body">
                        ...
                        <div class="nk-block-head">
                            <div class="nk-block-head-content">
                                <h4 class="nk-block-title">للأسف، لم يتمكن الدفع من النجاح.</h4>
                                <div class="nk-block-des text-success">
                                    <p>
                                        تمت محاولة الدفع باستخدام بطاقة الائتمان / الخصم، ولكن تم رفض الدفع لسبب ما. يمكن أن يكون السبب في انتهاء صلاحية البطاقة أو عدم توافر الأموال الكافية في الحساب، أو أي سبب آخر. سنحتاج إلى إعادة المحاولة في وقتٍ لاحق أو استخدام طريقة دفعٍ بديلة. يرجى التحقق من تفاصيل البطاقة والتأكد من صحتها، وإعادة المحاولة مرة أخرى إذا لزم الأمر.
                                    </p>
                                </div>
