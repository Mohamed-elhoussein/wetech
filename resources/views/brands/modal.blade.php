...
@section('title', 'إضافة نوع جهاز جديد')

@section('content')

<form class="m-5" action="{{ route('brands.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row d-flex justify-content-end mb-4">
        <button type="submit" class=" col-sm-6 col-md-2 btn btn-primary w-md fs-4 p-1">أضف نوع جهاز</button>
    </div>
</form>
