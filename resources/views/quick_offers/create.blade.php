                        ...
                        <div class="card-body">
                            ...
                            <form class="m-5" action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="title" placeholder=" أدخل عنوان العرض"
                                ...
                                <div class="row mb-4">
                                    <label for="horizontal-title_en-input" class="col-sm-3 col-form-label fs-4">العنوان
                                        بالإنجليزي</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="title_en" placeholder="أدخل عنوان العرض بالإنجليزي  "
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" placeholder="أدخل الوصف" name="body" id="horizontal-body-input" rows="4"></textarea>
                                    </div>
                                </div>
                                <div class="row mb-4">
